...
class Province {
  ...
  Province({this.name, this.slug, this.nameWithType, this.code, this.type, List<District>? districts}) : this.districts = districts ?? <District>[];
...
class District {
  ...
  District({this.name, this.slug, this.pathWithType, this.nameWithType, this.code, this.type, List<Wards>? wards}) : this.wards = wards ?? <Wards>[];
