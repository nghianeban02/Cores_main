...
void main() {
  runApp(ActivationSuccessApp());
}

class ActivationSuccessApp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      debugShowCheckedModeBanner: false,
      home: ActivationSuccessScreen(),
    );
  }
}
...
class ActivationSuccessScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBarV2(title: "Thông tin kích hoạt"),
      body: Container(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildInfoRow('Ngày kích hoạt', '20/07/2024'),
                    Divider(thickness: 1),
                    _buildInfoRow('Tiền thưởng', '10.000đ'),
                  ],
                ),
              ),
            ),
